            ...
            <forms className="m-0 p-0">
                ...
                <div className='row m-0 p-0'>
                    <div className='col-12 col-md-4 col-lg-4 m-0 p-2 py-3'>
                        ...
                        <input type=" text" className='col-12 m-0 p-0 w-100' placeholder='Jessica'></input>
                    </div>
                    <div className='col-12 col-md-4 col-lg-4 m-0 p-2 py-3'>
                        <label className='col-12 m-0 p-0 pb-2'>Last Name</label>
                        <input type=" text " className='col-12 m-0 p-0 w-100' placeholder='Mark'></input>
                    </div>
                    <div className='col-12 col-md-4 col-lg-4 m-0 p-2 py-3'>
                        <label className='col-12 m-0 p-0 pb-2'>Email Address</label>
                        <input type="email" className='col-12 m-0 p-0 w-100' placeholder='jessica@gmail.com'></input>
                    </div>
                </div>
                <div className='row m-0 p-0'>
                    <div className='col-12 col-md-4 col-lg-4 m-0 p-2 py-3'>
                        <label className='col-12 m-0 p-0 pb-2'>Gender</label>
                        <select className='form-select m-0 col-12 m-0 gdiv d-flex align-items-center w-100'>
                    ...
                    <div className='col-12 col-md-4 col-lg-4 m-0 p-2 py-3'>
                        ...
                        <input type="number" className='col-12 m-0 p-0 w-100' placeholder='+1 (201) 874 8486'></input>
                    </div>
                </div>
                <div className='row m-0 p-0'>
                    <div className='col-12 col-md-4 col-lg-4 m-0 p-2 py-3'>
                        <label className='col-12 m-0 p-0 pb-2'>Address</label>
                        <input type=" text" className='col-12 m-0 p-0 w-100' placeholder='1027 Edgardo'></input>
                    </div>
                    <div className='col-12 col-md-4 col-lg-4 m-0 p-2 py-3'>
                        <label className='col-12 m-0 p-0 pb-2'>City</label>
                        <input type=" text" className='col-12 m-0 p-0 w-100' placeholder='Arlington'></input>
                    </div>
                    <div className='col-12 col-md-4 col-lg-4 m-0 p-2 py-3'>
                        <label className='col-12 m-0 p-0 pb-2'>State</label>
                        <input type=" text" className='col-12 m-0 p-0 w-100' placeholder='Virginia'></input>
                    </div>
                </div>
                <div className='row m-0 p-0'>
                    <div className='col-12 col-md-4 col-lg-4 m-0 p-2 py-3'>
                        <label className='col-12 m-0 p-0 pb-2'>Postal code</label>
                        <input type=" text" className='col-12 m-0 p-0 w-100' placeholder='22201'></input>
                    </div>
                </div>
            </forms>
        </div>
