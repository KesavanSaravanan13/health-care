            ...
            <forms className="m-0 p-0" id="formEle">
                ...
                <div className='row m-0 p-0'>
                    <div className='col-12 col-md-4 col-lg-4 m-0 p-2 py-3'>
                        ...
                        <input type="text" className='col-12 m-0 w-100' disabled placeholder='First Name' value=""></input>
                    </div>
                    <div className='col-12 col-md-4 col-lg-4 m-0 p-2 py-3'>
                        <label className='col-12 m-0 p-0 pb-2'>Last Name</label>
                        <input type="text" className='col-12 m-0 w-100' disabled placeholder='Last Name' value='' ></input>
                    </div>
                    <div className='col-12 col-md-4 col-lg-4 m-0 p-2 py-3'>
                        <label className='col-12 m-0 p-0 pb-2'>Email Address</label>
                        <input type="email" className='col-12 m-0 w-100' disabled placeholder='Email' value=''></input>
                    </div>
                </div>
                <div className='row m-0 p-0'>
                    <div className='col-12 col-md-4 col-lg-4 m-0 p-2 py-3'>
                    ...
                    <div className='col-12 col-md-4 col-lg-4 m-0 p-2 py-3'>
                        ...
                        <input type="number" className='col-12 m-0 w-100' disabled placeholder='Enter the Phone Number' value=''></input>
                    </div>
                </div>
                <div className='row m-0 p-0'>
                    <div className='col-12 col-md-4 col-lg-4 m-0 p-2 py-3'>
                        <label className='col-12 m-0 p-0 pb-2'>Address</label>
                        <input type=" text" className='col-12 m-0 w-100' disabled placeholder='Enter the Address' value=''></input>
                    </div>
                    <div className='col-12 col-md-4 col-lg-4 m-0 p-2 py-3'>
                        <label className='col-12 m-0 p-0 pb-2'>City</label>
                        <input type=" text" className='col-12 m-0 w-100' disabled placeholder='Enter the City' value=''></input>
                    </div>
                    <div className='col-12 col-md-4 col-lg-4 m-0 p-2 py-3'>
                        <label className='col-12 m-0 p-0 pb-2'>State</label>
                        <input type=" text" className='col-12 m-0 w-100' disabled placeholder='Enter the State' value=''></input>
                    </div>
                </div>
                <div className='row m-0 p-0'>
                    <div className='col-12 col-md-4 col-lg-4 m-0 p-2 py-3'>
                        <label className='col-12 m-0 p-0 pb-2'>Postal code</label>
                        <input type=" text" className='col-12 m-0 w-100' disabled placeholder='Enter the pincode' value=''></input>
                    </div>
                </div>
                <Submit id='submitBtn'/>
            </forms>
